...
settings.DataStoreKey = require(script.Parent.DataStoreKey)             -- CHANGE THIS TO SOMETHING RANDOM! Key used to encrypt all datastore entries; Changing this will lose any saved data
...
settings.Ranks = {
    ...
    ["Creators"] = {
        ...
        Users = {
            3794951,--// Add users here (Also, don't forget quotations and all that)
            56160103
        };
    };
};
